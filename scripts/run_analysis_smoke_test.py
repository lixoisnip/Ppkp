    ...
    commands: list[SmokeCommand] = [
        ...
        SmokeCommand(
            ...
            [
                ...
                "docs/emulator/sfr_trace.csv",
                "docs/emulator/code_read_trace.csv",
                "docs/emulator/pzu_load_metadata.csv",
                "docs/emulator/direct_memory_trace.csv",
                "docs/emulator/uart_sbuf_trace.csv",
                "docs/emulator/cpu_subset_coverage.csv",
            ],
            "smoke scenario; success means deterministic run and clean unsupported-opcode reporting without crash",
        ),
        SmokeCommand(
            "firmware_execution_sandbox.py:packet_bridge_seeded_context",
            "experimental_emulator",
            [
                sys.executable,
                "scripts/firmware_execution_sandbox.py",
                "run-scenario",
                "packet_bridge_seeded_context",
                "--max-steps",
                "100",
            ],
            [
            ...
            "seeded packet bridge scenario with deterministic XDATA context",
        ),
        SmokeCommand(
            "firmware_execution_sandbox.py:boot_probe_static",
            "experimental_emulator",
            [
                sys.executable,
                "scripts/firmware_execution_sandbox.py",
            ...
            "diagnostic boot probe from 0x4000/0x4100; should stop safely on unsupported behavior",
        ),
        ...
        SmokeCommand(
            "project_guided_micro_decompiler_pass3.py",
            "project_guided_static",
            [sys.executable, "scripts/project_guided_micro_decompiler_pass3.py"],
            [
