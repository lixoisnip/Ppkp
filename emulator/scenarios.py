...
SCENARIOS = {
    ...
    "boot_4100_seed_x0030_zero_pointer": Scenario(
        name="boot_4100_seed_x0030_zero_pointer",
        firmware_file="90CYE03_19_DKS.PZU",
        functions=[0x4100],
        seed_xdata={0x0030: 0x00, 0x0031: 0x00},
        watchpoints=default_dks_watchpoints(),
        purpose="Hypothesis-only boot seed: XDATA[0x0030..0x0031]=0x0000 (zero pointer).",
    ),
    "boot_4100_seed_x0030_self_pointer": Scenario(
        name="boot_4100_seed_x0030_self_pointer",
        firmware_file="90CYE03_19_DKS.PZU",
        functions=[0x4100],
        seed_xdata={0x0030: 0x30, 0x0031: 0x00},
        watchpoints=default_dks_watchpoints(),
        purpose="Hypothesis-only boot seed: XDATA[0x0030..0x0031]=0x0030 (self pointer candidate).",
    ),
    "boot_4100_seed_x0030_to_0200_ff": Scenario(
        name="boot_4100_seed_x0030_to_0200_ff",
        firmware_file="90CYE03_19_DKS.PZU",
        functions=[0x4100],
        seed_xdata={0x0030: 0x00, 0x0031: 0x02, 0x0200: 0xFF},
        watchpoints=default_dks_watchpoints(),
        purpose="Hypothesis-only boot seed: pointer to 0x0200 with 0xFF terminator candidate.",
    ),
    "boot_4100_seed_x0030_to_0200_00": Scenario(
        name="boot_4100_seed_x0030_to_0200_00",
        firmware_file="90CYE03_19_DKS.PZU",
        functions=[0x4100],
        seed_xdata={0x0030: 0x00, 0x0031: 0x02, 0x0200: 0x00},
        watchpoints=default_dks_watchpoints(),
        purpose="Hypothesis-only boot seed: pointer to 0x0200 with 0x00 terminator/empty candidate.",
    ),
    "boot_4100_seed_x0030_to_0200_02_record": Scenario(
        name="boot_4100_seed_x0030_to_0200_02_record",
        firmware_file="90CYE03_19_DKS.PZU",
        functions=[0x4100],
        seed_xdata={0x0030: 0x00, 0x0031: 0x02, 0x0200: 0x02, 0x0203: 0x00, 0x0204: 0x03, 0x0300: 0x00},
        watchpoints=default_dks_watchpoints(),
        purpose="Hypothesis-only boot seed: pointer to 0x0200 with 0x02 record-like bytes.",
    ),
    "boot_4100_seed_x0030_to_0200_0a_record": Scenario(
        name="boot_4100_seed_x0030_to_0200_0a_record",
        firmware_file="90CYE03_19_DKS.PZU",
        functions=[0x4100],
        seed_xdata={0x0030: 0x00, 0x0031: 0x02, 0x0200: 0x0A, 0x0204: 0x00},
        watchpoints=default_dks_watchpoints(),
        purpose="Hypothesis-only boot seed: pointer to 0x0200 with 0x0A flag-setting candidate.",
    ),
    "boot_4100_ret_stack_to_4176": Scenario(
        name="boot_4100_ret_stack_to_4176",
        firmware_file="90CYE03_19_DKS.PZU",
        functions=[0x4100],
        seed_xdata={0x0030: 0x00, 0x0031: 0x02, 0x0200: 0xFF},
        watchpoints=default_dks_watchpoints(),
        purpose="Hypothesis-only boot stack continuation seed: RET target 0x4176.",
    ),
    "boot_4100_ret_stack_to_41D0": Scenario(
        name="boot_4100_ret_stack_to_41D0",
        firmware_file="90CYE03_19_DKS.PZU",
        functions=[0x4100],
        seed_xdata={0x0030: 0x00, 0x0031: 0x02, 0x0200: 0xFF},
        watchpoints=default_dks_watchpoints(),
        purpose="Hypothesis-only boot stack continuation seed: RET target 0x41D0.",
    ),
    "boot_4100_ret_stack_to_492E": Scenario(
        name="boot_4100_ret_stack_to_492E",
        firmware_file="90CYE03_19_DKS.PZU",
        functions=[0x4100],
        seed_xdata={0x0030: 0x00, 0x0031: 0x02, 0x0200: 0xFF},
        watchpoints=default_dks_watchpoints(),
        purpose="Hypothesis-only boot stack continuation seed: RET target 0x492E.",
    ),
    "boot_4100_ret_stack_to_4954": Scenario(
        name="boot_4100_ret_stack_to_4954",
        firmware_file="90CYE03_19_DKS.PZU",
        functions=[0x4100],
        seed_xdata={0x0030: 0x00, 0x0031: 0x02, 0x0200: 0xFF},
        watchpoints=default_dks_watchpoints(),
        purpose="Hypothesis-only boot stack continuation seed: RET target 0x4954.",
    ),
    "boot_4100_ret_stack_to_497A": Scenario(
        name="boot_4100_ret_stack_to_497A",
        firmware_file="90CYE03_19_DKS.PZU",
        functions=[0x4100],
        seed_xdata={0x0030: 0x00, 0x0031: 0x02, 0x0200: 0xFF},
        watchpoints=default_dks_watchpoints(),
        purpose="Hypothesis-only boot stack continuation seed: RET target 0x497A.",
    ),
    "boot_4100_ret_stack_to_5710": Scenario(
        name="boot_4100_ret_stack_to_5710",
        firmware_file="90CYE03_19_DKS.PZU",
        functions=[0x4100],
        seed_xdata={0x0030: 0x00, 0x0031: 0x02, 0x0200: 0xFF},
        watchpoints=default_dks_watchpoints(),
        purpose="Hypothesis-only boot stack continuation seed: RET target 0x5710.",
    ),
    "boot_4100_ret_stack_to_55AD": Scenario(
        name="boot_4100_ret_stack_to_55AD",
        firmware_file="90CYE03_19_DKS.PZU",
        functions=[0x4100],
        seed_xdata={0x0030: 0x00, 0x0031: 0x02, 0x0200: 0xFF},
        watchpoints=default_dks_watchpoints(),
        purpose="Hypothesis-only boot stack continuation seed: RET target 0x55AD.",
    ),
    "boot_4100_ret_stack_default_unseeded": Scenario(
        name="boot_4100_ret_stack_default_unseeded",
        firmware_file="90CYE03_19_DKS.PZU",
        functions=[0x4100],
        seed_xdata={0x0030: 0x00, 0x0031: 0x02, 0x0200: 0xFF},
        watchpoints=default_dks_watchpoints(),
        purpose="Hypothesis-only boot stack continuation probe with default unseeded stack bytes.",
    ),
    "config_record_seed_terminator_ff": Scenario(
        name="config_record_seed_terminator_ff",
        firmware_file="90CYE03_19_DKS.PZU",
        functions=[0x4100],
        seed_xdata={0x0030: 0x00, 0x0031: 0x02, 0x0200: 0xFF},
        watchpoints=default_dks_watchpoints(),
        purpose="Hypothesis-only 8-byte record model seed: root pointer to 0x0200 with 0xFF terminator candidate.",
    ),
    "config_record_seed_type02_minimal": Scenario(
        name="config_record_seed_type02_minimal",
        firmware_file="90CYE03_19_DKS.PZU",
        functions=[0x4100],
        seed_xdata={0x0030: 0x00, 0x0031: 0x02, 0x0200: 0x02, 0x0202: 0x03, 0x0203: 0x00, 0x0300: 0x00},
        watchpoints=default_dks_watchpoints(),
        purpose="Hypothesis-only 8-byte record model seed: type 0x02 record with minimal nested pointer ending in 0x00.",
    ),
    "config_record_seed_type02_chain_to_0a": Scenario(
        name="config_record_seed_type02_chain_to_0a",
        firmware_file="90CYE03_19_DKS.PZU",
        functions=[0x4100],
        seed_xdata={
            0x0030: 0x00,
        ...
        watchpoints=default_dks_watchpoints(),
        purpose="Hypothesis-only 8-byte record model seed: 0x02 record chain pointing to 0x0A-tagged nested candidate.",
    ),
    "config_record_seed_type02_with_address_sequence": Scenario(
        name="config_record_seed_type02_with_address_sequence",
        firmware_file="90CYE03_19_DKS.PZU",
        functions=[0x4100],
        seed_xdata={
            0x0030: 0x00,
            ...
            0x0203: 0x20,
            0x3200: 0x0A,
            **{(0x3201 + i): (0x01 + i) for i in range(0x23)},
        },
        watchpoints=default_dks_watchpoints(),
        purpose="Hypothesis-only 8-byte record model seed: 0x02 record chain with deterministic 0x3201..0x3223 address-like sequence.",
    ),
